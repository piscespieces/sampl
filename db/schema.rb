...
ActiveRecord::Schema[7.0].define(version: 2023_03_29_174630) do
  ...
  create_table "genres_sample_packs", id: false, force: :cascade do |t|
  ...
  create_table "sample_tags_samples", id: false, force: :cascade do |t|
